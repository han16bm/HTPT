...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> entity)
    {
        ...
        entity.Property(e => e.RoleId).HasColumnType("NUMBER").HasColumnName("ROLE_ID");
        ...
        entity.Property(e => e.LastLoginAt).HasColumnType("DATE").HasColumnName("LAST_LOGIN_AT");
        ...
        entity.Property(e => e.IsAdmin).HasDefaultValueSql("0 ").HasColumnType("NUMBER(1)").HasColumnName("IS_ADMIN");
        ...
        entity.Property(e => e.ResetTokenExp).HasColumnType("DATE").HasColumnName("RESET_TOKEN_EXP");
