...
builder.Host.UseSerilog((ctx, cfg) =>
    cfg.ReadFrom.Configuration(ctx.Configuration)
       .WriteTo.Console()
       .WriteTo.File("logs/api-products-.log", rollingInterval: RollingInterval.Day));
...
services.AddControllers(options =>
{
    ...
    options.Conventions.Add(new ApiPrefixRouteConvention("products"));
...
{
    c.SwaggerDoc("v1", new() { Title = "API.Products — Fish Shop", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.DocumentTitle = "API.Products — Fish Shop";
